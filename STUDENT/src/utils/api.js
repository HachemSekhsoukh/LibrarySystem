...
export const logoutStudent = async () => {
  try {
    ...
    const data = await response.json();
    console.log('Logout successful:', data);
    console.log('Redirecting to lougout.jsx...');
    return data;
  } catch (error) {
    console.error('Logout error:', error);
    return null;
...
export const getUserInfo = async () => {
  try {
    const response = await fetch(`${API_BASE_URL}/student/user/me`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const updateUserInfo = async (updatedData) => {
  try {
    const response = await fetch(`${API_BASE_URL}/student/user/update`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const updateUserPassword = async (oldPassword, newPassword) => {
  try {
    const response = await fetch(`${API_BASE_URL}/student/user/update-password`, {
      method: "PUT",
...
export async function checkAuthStatus() {
  try {
    const response = await fetch(`${API_BASE_URL}/student/user/status`, {
      method: 'GET',
...
export const fetchTransactionsByReaderId = async (readerId) => {
  console.log("readerId");
  console.log(readerId);
  console.log("before fetch");
  const response = await fetch(`${API_BASE_URL}/transactions/user/${readerId}`);
